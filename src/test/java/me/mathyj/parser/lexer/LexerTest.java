package me.mathyj.parser.lexer;
...
import static me.mathyj.parser.token.Token.*;
...
class LexerTest {
    ...
    void nextToken() {
        ...
        for (var i = 0; i < expectedTokenList.size(); i++) {
            ...
            assertEquals(expected, actual, "tests[%d] me.mathyj.parser.token type wrong. expected=%s, got=%s".formatted(i, expected, actual));
        }
    }
}